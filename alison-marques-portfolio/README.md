# Alison Marques | Portfólio Profissional

Um portfólio moderno e responsivo desenvolvido com React 19, TypeScript, Tailwind CSS e Vite. Otimizado para performance, SEO e acessibilidade.

**Visite:** [alisonmarques.com](https://alisonmarques.com)

---

## ✨ Características

- ✅ **Totalmente Responsivo** - Mobile-first design com suporte completo para desktop, tablet e smartphone
- ✅ **Otimizado para SEO** - Meta tags, Open Graph, e schema.org estruturado
- ✅ **Performance Otimizada** - Build otimizado com Vite, lazy loading de imagens
- ✅ **Acessibilidade** - WCAG 2.1 AA compliance, ARIA labels, navegação por teclado
- ✅ **Formulário Funcional** - Integração com Formspree para contato direto
- ✅ **Tema Customizável** - Sistema de temas com Tailwind CSS
- ✅ **Analytics** - Suporte para Umami Analytics (privacidade first)
- ✅ **Deploy Rápido** - Pronto para Vercel, Netlify, GitHub Pages
...
### Backend (Opcional)
- **Express.js** - Server para SSR ou API
...
git clone https://github.com/alisondossantos21-cmyk/alison-marques-portfolio.git
...
```env
# Domínio (para meta tags)
VITE_DOMAIN=https://alisonmarques.com
...
3. Copie o endpoint do formulário
4. Adicione ao `.env.local`: `VITE_FORMSPREE_ENDPOINT=https://formspree.io/f/YOUR_ID`

Sem configuração, o formulário abrirá o cliente de email padrão (fallback).

### Analytics

Para ativar analytics com Umami:

1. Visite [Umami Analytics](https://umami.is/)
2. Configure seu website
3. Copie o script endpoint e website ID
...
client/
  ...
  │   └── __manus__/      # Debug logs (desenvolvimento)
  └── src/
...
Ou conecte seu repositório Git no [Vercel Dashboard](https://vercel.com/).
...
```bash
# 1. Configure o repositório como público
# 2. Vá em Settings > Pages
# 3. Selecione "Deploy from a branch"
# 4. Escolha a branch com seu build (dist/)
```

### Deploy Personalizado (VPS/Servidor)
...
# 3. Configure o servidor para SPA (Single Page Application)
# Redirecione todas as rotas para index.html
```
...
- ✅ Twitter Card tags
- ✅ Canonical URL
- ✅ Sitemap (considere adicionar)
- ✅ robots.txt (considere adicionar)
...
- Use `pnpm build` regularmente para verificar tamanho do bundle
- Monitore Core Web Vitals com [PageSpeed Insights](https://pagespeed.web.dev/)
- Use [GTmetrix](https://gtmetrix.com/) para testes detalhados
...
- ✅ Skip links (implementar se necessário)
...
# Linting (opcional - configure conforme necessário)
...
### Alterar Cores
Edite `client/src/index.css` para modificar o tema Tailwind:
...
@layer base {
  :root {
    --background: 0 0% 100%;
    --foreground: 0 0% 3.6%;
    --accent: 0 84.2% 60.2%; /* Cor principal */
    /* ... outras cores */
  }
}
```
...
2. Importe no `Home.tsx`
3. Adicione um `id` para navegação
4. Atualize a navegação se necessário

### Modificar Conteúdo
- **Sobre**: Edite `Home.tsx` seção "SOBRE MIM"
- **Projetos**: Atualize o array `projects` em `Home.tsx`
- **Habilidades**: Atualize o array `skills` em `Home.tsx`
...
- Verifique se `VITE_FORMSPREE_ENDPOINT` está configurado
- Teste sem configuração (deve abrir cliente de email)
...
- Teste CORS se necessário
- Use CDN confiável (CloudFront, Cloudinary, etc)
...
**Alison Marques**
- 🔗 [GitHub](https://github.com/alisondossantos21-cmyk)
- 🔗 [LinkedIn](https://www.linkedin.com/in/alison-marques-b656b62b4/)
- 📧 [Email](mailto:alisondossantos21@gmail.com)

---

## 🤝 Contribuições

Sugestões de melhorias são bem-vindas! Abra uma issue ou faça um PR.
...
1. Verifique as seções de Troubleshooting e FAQ
...
<html lang="en">
  ...
  <head>
    ...
    <title>Alison Marques | Portfólio</title>    
